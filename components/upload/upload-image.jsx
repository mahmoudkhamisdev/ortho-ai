...
export default function UploadImage({ size = 5, onChange, value, className }) {
    ...
    initialFiles: [
      {
        ...
        url: value?.file_path && `${UrlImage}${value?.file_path}`,
        id: value?.id,
      },
    ],
